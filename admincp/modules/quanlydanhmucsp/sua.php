            ...
            <div class="col-4">
                ...
                <form action="xyly.php" method="post">
                    <div class="input-group input-group-sm mb-2 row">
                        ...
                        <input type="text" class="form-control col-8" name="tenhangsp" value="<?php echo $data_sua['tenhangsp'] ?>">
                    </div>
                    <div class="input-group input-group-sm mb-2 row">
                        <p class="fs-6 mb-0 col-4">Thứ tự</p>
                        <input type="text" class="form-control col-8" name="thutusp" value="<?php echo $data_sua['stt'] ?>">
                    </div>
                    <button type="submit" class="btn btn-primary btn-sm" name="suasanpham">Cập nhật</button>
