                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav fs-6">
                            <li class="nav-item dropdown">
                                <button class="btn dropdown-toggle d-flex align-items-center p-0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="list-group-container d-flex ">
                                        ...
                                        <div class="list-product-by-price">
                                            <div class="list-group">
                                                ...
                                                <a href='#' class='list-group-item list-group-item-action'>Dưới 5 triệu</a>
                                                <a href='#' class='list-group-item list-group-item-action'>Từ 5 - 10 triệu</a>
                                                <a href='#' class='list-group-item list-group-item-action'>Từ 10 - 15 triệu</a>
                                                <a href='#' class='list-group-item list-group-item-action'>Từ 15 - 20 triệu</a>
                                                <a href='#' class='list-group-item list-group-item-action'>Từ 20 - 30 triệu</a>
                                                <a href='#' class='list-group-item list-group-item-action'>Trên 30 triệu</a>
                                            </div>
                                        </div>
