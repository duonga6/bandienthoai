                ...
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        <div class="card-content">
                            <h5 class="card-title mb-3"><a href="index.php?navigate=show_pro&id_sp=<?php echo $id_sp ?>" class="text-dark text-decoration-none"><?php echo $row_sp['ten_sp'] ?></a></h5>
                            <span class="text-danger h4 mb-3 d-block"><?php echo number_format($row_sp['gia'],0,',','.'). 'đ' ?></span>
                        </div>
