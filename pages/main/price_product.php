<?php
    ...
    if ($_GET['to'] != -1) {
     ...
     ORDER BY id_sp ASC LIMIT $begin, 4";
    }
...
<div class="product">
    <div class="container" style="min-height:800px">
        <?php
            if (isset($_GET['to'])) {
        ?>
        <p class="product-heading mt-0 py-3 fs-5 fw-bold">Sản phẩm có giá từ <?php echo $from ?> - <?php echo $to ?> triệu (<?php echo $query_data ?>)</p>
        <?php
            }else {
        ?>
        <p class="product-heading mt-0 py-3 fs-5 fw-bold">Sản phẩm có giá trên <?php echo $from ?> triệu (<?php echo $query_data ?>)</p>
        <?php
            }
        ?>
                ...
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        <div class="card-content">
                            <h5 class="card-title mb-3"><a href="index.php?navigate=show_pro&id_sp=<?php echo $id_sp ?>" class="text-dark text-decoration-none"><?php echo $row_pro['ten_sp'] ?></a></h5>
                            <span class="text-danger h4 mb-3 d-block"><?php echo number_format($row_pro['gia'],0,',','.'). 'đ' ?></span>
                        </div>
                        <div class="product-actions">
                            <a href="#" class="btn btn-primary btn-sm m-1">Thêm vào giỏ hàng</a><br>
